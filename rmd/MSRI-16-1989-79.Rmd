...
\oldpage{33 (112)}The study of the fundamental group of $\PP^1\setminus\{0,1,\infty\}$ reveals, for each $k\geq2$, a torsor $P_{1,k}$ under $\ZZ(k)$ on $\Spec(\ZZ)$.
...
We will then describe the torsors $P_{d,k}$ under $\ZZ(k)$ on $\Spec(\QQ(\sqrt[d]{1}))$, given by an analogous construction [(16.28)](#chunk-16.28).
