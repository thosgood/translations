...
if (knitr::is_html_output()) {
  cat('\\providecommand{\\simto}{\\xrightarrow{\\sim}}')
} else {
  cat('\\providecommand{\\simto}{\\newcommand{\\simto}{\\xrightarrow{\\raisebox{-0.7ex}[0ex][0ex]{$\\sim$}}}}')
}
```
...
$$
  ...
  \\\comp_{\AAf,\BB}\colon
    &M_\BB^{(C)}\otimes\AAf \to \text{inverse image on }S(C)\text{ of }M_\AAf
  \end{aligned}
$$
