...
::: {.trmenv #M1PZ title="(M1)P$\ZZ$" latex="{(M1)P$\ZZ$}"}
$P_\BB$ is an $M_\BB$-torsor.
:::

::: {.trmenv #M3,9PZ title="(M3,9)P$\ZZ$" latex="{(M3,9)P$\ZZ$}"}
...
::: {.trmenv #M5PZ title="(M5)P$\ZZ$" latex="{(M5)P$\ZZ$}"}
...
$$
  \begin{aligned}
    \phi_p^{-1}(k+m)
    &= \phi_p^{-1}(k) + pm
  \\\dd\phi_p^{-1}(0) = \widetilde{F}^\bullet\left(\frac{\dd q}{q}\right) - p\frac{\dd q}{q}.
  \end{aligned}
$$
