...
With the definition [(1.17)](#chunk-1.17) of smooth realisation systems over $S=\Spec(\OO)$, the functor given by forgetting the $A$-module structure, which takes values in smooth realisation systems over $\Spec(\ZZ)\setminus P$, is called the "*direct image of $S$ in $\Spec(\ZZ)\setiminus P$*".
