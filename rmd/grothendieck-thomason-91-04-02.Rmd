...
Indeed, the toposes that have as sheaves of sets the $\mathcal{C}^\wedge$, with $\mathcal{C}$ in $\Cat$, are by far the simplest of the known toposes, and it is because I believe this that I stressed so much the examples of these ("categorical") toposes in SGA 4 IV [@2].
...
\oldpage{8}
(In any case, I am cheating a bit here, for lacking of having spelled out the restrictions on the degrees of the complexes, like $D^+(\mathcal{X},k)$ or $D^-(\mathcal{X},k)$. But here is not the place to enter into technicalities.)
