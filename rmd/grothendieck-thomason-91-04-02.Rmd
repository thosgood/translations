...
But I emphasise right away that, for me, the true purpose of operations on the level of model categories is to obtain operations on the associated derivators (or pre-derivators, to begin with).

On this subject, a remark on the subject of the functoriality of the pre-derivator associated to a model category $(\cal{M},W)$.
