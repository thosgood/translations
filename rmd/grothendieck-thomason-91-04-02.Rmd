...
The category of "true" triangles can be obtained by taking $I=\Delta^1$, and the derived categories of filtered complexes, introduced by Illusie to **??? (« sauver la mise à bon compte »)**, correspond to the case $I=\Delta^n$ (the simplex type of dimension $n$).
