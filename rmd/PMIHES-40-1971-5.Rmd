...
The constructions [(1.2.4)](#chunk-1.2.4) and [(1.2.5)](#chunk-1.2.5) establish equivalences of categories that are quasi-inverse to one another between objects of $\scr{A}$ endowed with two finite $n$-opposite filtrations and bigraded objects of $\scr{A}$ of the type considered in [(1.2.4)](#chunk-1.2.4).
:::
...
$$
whence decompositions [(1.2.4)](#chunk-1.2.4), [(1.2.5)](#chunk-1.2.5)
$$
  W^n(A)/W^{n+1}(A)
