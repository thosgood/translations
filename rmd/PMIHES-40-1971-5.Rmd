...
By [(1.3.3)](#chunk-1.3.3) and [(1.3.4)](#proposition-1.3.4), the complex $E_1(K,W)$ filtered by $F$ is a quotient of the filtered complex $\Gr_{\Dec(W)}(K)$.
...
\oldpage{19}
By [(1.3.15)](#lemma-1.3.15), the morphism $u\colon E_0(\Dec(K))\to E_1(K)$ is a filtered quasi-isomorphism.
...
A *$T$-acyclic filtered resolution* of $K$ is
:::
