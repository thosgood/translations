...
# (PART) Mixed manifolds and mixed spaces {-}

# I. Category of models {#two-section-I}
...
# II. The definition of mixed spaces and mixed varieties {#two-section-II}

## 1. First definition {#two-section-II.1}
...
## 2. An equivalent definition {#two-section-II.2}
...
## 3. Deformations {#two-section-II.3}
...
# III. Vector fields {#two-section-III}

## 1. Study on models {#two-section-III.1}
...
## 2. Vector fields on a mixed manifold {#two-section-III.2}
...
# IV. The Spencer--Kodaira map {#two-section-IV}
...
# I. The map $\widetilde{\rho}$ {#three-section-I}
...
# II. The regular case {#three-section-II}
...
# III. An example of non-regular deformation: Hopf manifolds {#three-section-III}

## 1. Hopf manifolds {#three-section-III.1}
...
## 2. Mixed manifolds whose fibres are Hopf manifolds {#three-section-III.2}
...
## 3. Calculation of $\rho$ {#three-section-III.3}
...
## 4. A counter-example {#three-section-III.4}
...
## 5. Question (K. Srinivasacharyulu) {#three-section-III.5}
...
# (PART) The primary obstruction to deformation {-}

# Introduction {#four-introduction}
...
# I. Exact sequences of sheaves of algebras {#four-section-I}
...
# II. The primary obstruction {#four-section-II}
...
# III. An example of obstruction {#four-section-III}

## 1. The manifold $V_0$ {#four-section-III.1}
...
## 2. The mixed space $V$ {#four-section-III.2}
...
## 3. Calculating $\rho_0$ {#four-section-III.3}
...
# I. Definition of obstructions {#four-appendix-I}

## 1. The sheaf of germs of vertical automorphisms {#four-appendix-I.1}
