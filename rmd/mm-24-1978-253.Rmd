...
It is important to know that, as in the case of complex spaces, the **!!TO-DO: intersection rings?!!** of compact Stein subsets of $X$ are excellent Noetherian rings ([(1.4)](#equation-1.4) and [(1.10)](#equation-1.10)).
Formal complex spaces can be (locally) embedded into **!!TO-DO: number spaces?!!**, cf. [(1.7)](#equation-1.7).
