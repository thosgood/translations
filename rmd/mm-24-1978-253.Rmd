...
1. $B_K\coloneqq\varprojlim_n\Gamma(K,\OO_{X_n})$ is a Noetherian ring, which is further separated and complete with respect to the topology defined by the ideal $\scr{b}_K\coloneqq\Ker(B_K\to\Gamma(K,\OO_{X_0}))$.
:::
