...
\begin{remark}
  ...
  There exists a function $u$ that is everywhere defined on $X$, and which is entire \todo? on the local ring of $x_0$, but which is not contained in this ring;
