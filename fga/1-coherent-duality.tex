...
\label{proposition4corollary1}
  ...
  \[
  \label{3.5}
    \Ext_A^p(\Omega^{n-p}(A/\mathfrak{J}),\Omega^n(A)) \cong A/\mathfrak{J}.
  \tag{3.5}
  \]
...
\oldpage{149-08}
  ...
  \[
  \label{3.6}
    \shExt_{\sh{O}_X}^p(\Omega_Y^{n-p},\Omega_X^n) \cong \sh{O}_Y
  \tag{3.6}
  \]
  as well as
  \[
  \label{3.6bis}
    \Ext_{\sh{O}_X}^p(\sh{O}_Y,\Omega_X^n) \cong \Omega_Y^{n-p}.
  \tag{3.6 \emph{bis}}
  \]
\end{corollary}
