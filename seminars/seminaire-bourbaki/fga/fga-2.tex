...
\begin{remark}
  ...
  \Cref{theorem10} also proves that the ``level~$n$ Jacobi schemes'' from the theory of modules are non-singular (and even simple over $\underline{\ZZ}$).
\end{remark}
