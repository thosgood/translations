...
recall (Exposé~10, Section~2) that the \emph{fibre} of \(X\) at \(s\) is
the fibre product \(X_s=X\times_S\{s\}\), where \(\{s\}\) is the
analytic space consisting of the point \(s\), endowed with the field
