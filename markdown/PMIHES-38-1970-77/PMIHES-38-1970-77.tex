...
\(\mathbf{FS}\)-spaces (or even of \(\mathbf{DFS}\)-spaces), and
...
\subsubsection*{(i) Germs in the neighbourhood of a
polydisc}\label{section-5.b.i}
\addcontentsline{toc}{subsubsection}{(i) Germs in the neighbourhood of a
polydisc}
...
\subsubsection*{\texorpdfstring{(ii) The morphism
\(L_K^\bullet\to L_{K'}^\bullet\)}{(ii) The morphism L\_K\^{}\textbackslash bullet\textbackslash to L\_\{K\textquotesingle\}\^{}\textbackslash bullet}}\label{section-5.b.ii}
\addcontentsline{toc}{subsubsection}{(ii) The morphism
\(L_K^\bullet\to L_{K'}^\bullet\)}

Let \(\alpha\) be a point of \(\operatorname{Spec}{{\mathscr{O}}_K}\) of
codimension~\(p\). We need to (following \hyperref[section-5.a]{§A},
...
\subsubsection*{\texorpdfstring{(iii) Surjectivity of
\(\lim_{K\ni x}L_K^\bullet\to L_x^\bullet\)}{(iii) Surjectivity of \textbackslash lim\_\{K\textbackslash ni x\}L\_K\^{}\textbackslash bullet\textbackslash to L\_x\^{}\textbackslash bullet}}\label{section-5.b.iii}
\addcontentsline{toc}{subsubsection}{(iii) Surjectivity of
