...
::: {.rmenv #i-definition-1.1 number="1.1" taxon="Definition"}
...
::: {.rmenv #i-principle-2.1 number="2.1" taxon="Principle"}
...
::: {.itenv #i-scholium taxon="Scholium"}
...
::: {.rmenv #i-principle-8.1 number="8.1" taxon="Principle"}
...
::: {.rmenv #i-subsection-8.5 number="8.5"}
...
::: {.rmenv #i-dictionary-9.1 number="9.1" taxon="Dictionary"}
| | |
| :- | :- |
| $D$ | $\Spec(V)$ |
| $D^*$ | $\Spec(K)$ |
