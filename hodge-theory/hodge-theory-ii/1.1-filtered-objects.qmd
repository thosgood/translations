...
::: {.rmenv #env-ii-1.1.3 title="1.1.3" latex="{1.1.3}"}
...
A morphism $f\colon(A,F)\to(B,F)$ is said to be **strict**, or **strictly compatible with the filtrations**, if the canonical arrows from $\Coim(f)$ to $\Im(f)$ is an isomorphism of filtered objects (cf. @env-ii-1.1.11).
:::

::: {.rmenv #env-ii-1.1.6 title="1.1.6" latex="{1.1.6}"}
...
::: {.rmenv #env-ii-1.1.8 title="1.1.8" latex="{1.1.8}"}
...
::: {.itenv #env-ii-1.1.9 title="Lemma 1.1.9" latex="{Lemma 1.1.9}"}
\oldpage{8}
...
::: {.rmenv #env-ii-1.1.10 title="1.1.10" latex="{1.1.10}"}
We call the filtration @env-ii-1.1.9 on $Y/X$ the **filtration induced by that of $A$** (or simply the **induced filtration**).
By @env-ii-1.1.9, its definition is self-dual.
...
::: {.itenv #env-ii-1.1.11 title="Proposition 1.1.11" latex="{Proposition 1.1.11}"}
...
::: {.rmenv #env-ii-1.1.12 title="1.1.12" latex="{1.1.12}"}
...
We extend these definitions to contravariant functors in certain variables by @env-ii-1.1.6.
