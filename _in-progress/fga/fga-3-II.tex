...
\oldpage{195-15}
  ...
  Of course, even after having proven the existence of the ``Chow scheme'' of $X$ over $S$, it remains to find a decomposition of it into disjoint open subsets $C_i$ (corresponding to the \todo?{fixation} of continuous invariants, such as degree and dimension of the cycles that we vary) over $S$, as well as to make precise the relations between this scheme with the classical Chow varieties, and to make precise when a $C_i$ is \emph{projective} (or at least quasi-projective) over $S$.
\end{remarks*}
