...
in this case, $P$ is a ``purely infinitesimal'' non-reduced (if it were reduced, it would simply be the trivial group) group, i.e. defined by a local algebra $\sh{O}$ of finite rank over the base field $k$ and endowed with a diagonal map corresponding to the multiplicative structure of $P$;
