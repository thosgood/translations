...
The above proposition then implies that the canonical functor $h$ defines an \emph{equivalence} between the category $\cat{C}$ and the full sub-category of $\Hom(\cat{C}^o,\Set)$ consisting of representable functors.
