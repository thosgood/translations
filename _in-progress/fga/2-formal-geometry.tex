...
The \hyperref[theorem14corollary1]{corollary} of \cref{theorem14}, which completely determines Galois covers of order prime to the characteristic of an algebraic curve over an algebraically closed field, has been used in an essential manner on three separate occasions:
\begin{enumerate}[1.]
