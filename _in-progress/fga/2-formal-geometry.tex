...
\begin{enumerate}[1.]
  ...
  \item in the study (developed independently by Ogg and \check{S}afarevi\check{c}) of the group of homogeneous principal bundles over an abelian variety defined over a function field in one variable, in arbitrary characteristic;
