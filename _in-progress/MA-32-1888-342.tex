...
Namely, let $F$, $F'$, and $F''$ be three definite ternary quartic forms, and $p$, $p'$, and $p''$ be three positive variables, whose relations to one another may be represented by points inside a coordinate triangle.
\oldpage{344}
