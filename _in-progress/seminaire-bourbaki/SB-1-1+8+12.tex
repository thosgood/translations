...
The elements upon which $\theta(X)$ acts as the identity (for \emph{all} $X\in\alpha$) are those which are simultaneously invariant under left- and right-translations, and are simply called \emph{invariant elements}.
