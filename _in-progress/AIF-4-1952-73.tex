...
\subsection{Calculation of \texorpdfstring{$\LL^1\hotimes E$}{L^1(x)E}}
\label{1.3}
...
\subsection{Integral linear maps to an \texorpdfstring{$\LL^1$}{L^1} space or a \texorpdfstring{$C_0(M)$}{C_0(M)} space}
\label{1.9}
