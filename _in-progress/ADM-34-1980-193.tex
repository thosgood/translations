...
For example, the inclusion functors of the category of commutative fields into the category of integral domains and into the category of local commutative rings are both proper multialgebraic.
...
\begin{rmenv}{1.2 Examples}
  ...
  \begin{rmenv}{1.2.1 The multialgebraic theory of integral domains}
    ...
    The dual category $\bb{D}_0^\op$ in which we distinguish the objects of the form $(1,I)$ is thus a multialgebraic theory, denoted by $\bb{M}$.
...
\oldpage{195}
    ...
    We define a functor $A^{(\,\,)}\colon\bb{M}\to\Set$ by $A^{(n,I)}=\{(x_1,\ldots,x_n)\in A^n:I_{x_1,\ldots,x_n}=I\}$ and, for a morphism $\langle g_1,\ldots,g_n\rangle\colon(n,I)\to(m,J)$ of $\bb{D}_0$, by
    \[
  ...
  \begin{rmenv}{1.2.2 The multialgebraic theory of local commutative rings}
  \end{rmenv}
