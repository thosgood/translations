...
\label{II.2.13}
  ...
  If there exists an extension of $\scr{V}$ on $X$ that is, locally on $Y$, meromorphically equivalent to the given extensions, then this extension is unique up to meromorphic equivalence;
...
\oldpage{66}
  ...
  a \emph{section} $v\in\HH^0(X^*,\scr{V})$ is said to be \emph{meromorphic along $Y$} if, locally on $X$, it is defined by a section of one of the given extensions of $\scr{V}$.
