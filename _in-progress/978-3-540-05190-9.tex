...
\label{II.6.13}
  ...
  \begin{enumerate}[(i)]
    ...
    \item the sheaves $\mathbb{R}^i f_*(\Omega_{X/S}^\bullet(\cal{V}))$ and $\RR^i f_*^\an(\Omega_{X^\an/S^\an}^\bullet(\cal{V}))$ are locally free and of finite type, and their construction is compatible with any base change;
