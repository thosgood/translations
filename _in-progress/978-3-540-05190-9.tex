...
\label{II.3.8}
  ...
  \[
  \label{II.3.8.2}
    \dot{\Gamma} \in j_*\Omega_{X^*}^1(\shEnd(\scr{V}_0))/\Omega_X^1(\shEnd(\scr{V}))
  \tag{3.8.2}
  \]
...
\oldpage{80}
  ...
  \[
  \label{II.3.12.2}
    P^k(j_*^\mathrm{m}\Omega_{X^*}^p(\scr{V}))
...
\oldpage{81}
      \[
      \label{II.3.13.1}
        \Gr_F(\Omega_X^\bullet\langle Y\rangle(\scr{V}))
        \to \Gr_P(j_*^\mathrm{m}\Omega_{X^*}^\bullet(\scr{V})).
      \tag{3.13.1}
      \]
  \end{enumerate}
\end{itenv}
...
\begin{proof}
  ...
  \begin{itemize}
    ...
    \item[] \textbf{Second reduction (Products).}
      ...
      \[
      \label{II.3.13.2}
        \Gr_F(\Omega_{X_1}^\bullet\langle Y_1\rangle(\scr{V}_1))
        \boxtimes \Gr_F(\Omega_{X_2}^\bullet\langle Y_2\rangle(\scr{V}_2))
        \simto \Gr_F(\Omega_X^\bullet\langle Y\rangle(\scr{V})).
      \tag{3.13.2}
      \]
...
\oldpage{82}
      ...
      \[
      \label{II.3.13.3}
        \Gr_P(j_*^\mathrm{m}\Omega_{X_1^*}^\bullet(\scr{V}_1))
        \boxtimes \Gr_P(j_*^\mathrm{m}\Omega_{X_2^*}^\bullet(\scr{V}_2))
        \simto \Gr_P(j_*^\mathrm{m}\Omega_{X^*}^\bullet(\scr{V})).
      \tag{3.13.3}
      \]
