...
\begin{proof}
  ...
  \begin{proof}
    Indeed, every section of $j_*\Omega_{X^*}^\bullet$ that is meromorphic along $Y$ can be written locally as $f=g\cdot\prod_{i=1}^k z_i^{k_i}$ with $g$ invertible, and
    \[
...
\label{II.3.3}
  ...
  \oldpage{75}
    ...
    \label{II.3.3.2.3}
      ...
      \[
        \langle v,\Omega_X^1\langle Y\rangle\rangle \subset \cal{O}_X.
      \]
    \end{itenv}
