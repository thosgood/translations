...
\label{II.7.3}
  ...
  If $K$ is a bounded-below complex of sheaves on $X$, then we denote by $f_*(\cal{U},K)$ the simple complex associated to the double complex of the $f_*(\cal{U},K^n)(\Delta_m)$, in which we take the first differential to be that induced by the functoriality of the differential $\dd$ of $K$, i.e.
  \[
  \label{II.7.3.1}
    \dd
    = \dd'+\dd''
    = f_*(\cal{U},\dd) + (-1)^n\sum(-1)^i\partial_i.
  \tag{7.3.1}
  \]
