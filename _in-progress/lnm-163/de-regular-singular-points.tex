...
\oldpage{34}
  \begin{enumerate}[(i)]
    ...
    \item The right-hand side of \cref{I.5.9.3} is invariant under the substitution
      ...
      \[
        \begin{aligned}
          \left\vert\begin{array}{cc}g&(\lambda g)'\end{array}\right\vert
          \quad&=\quad \left\vert\begin{array}{cc}\lambda g&\lambda g'+\lambda' g\end{array}\right\vert
        \\[0.5em]
          &=\quad \lambda^2\left\vert\begin{array}{cc}g&g'\end{array}\right\vert
        \\[1em]
          \left\vert\begin{array}{cc}\lambda g&(\lambda g)''/2\end{array}\right\vert
          \quad&=\quad \lambda^2\left\vert\begin{array}{cc}g&g''/2\end{array}\right\vert
          + \lambda\lambda'\left\vert\begin{array}{cc}g&g'\end{array}\right\vert
        \\[1em]
          \left\vert\begin{array}{cc}\lambda g&(\lambda g)'''/6\end{array}\right\vert
          \quad&=\quad \lambda^2\left\vert\begin{array}{cc}g&g'''/6\end{array}\right\vert
          + \lambda\lambda'\left\vert\begin{array}{cc}g&g''/2\end{array}\right\vert
        \\[0.5em]
          &\qquad+ (\lambda\lambda''/2)\left\vert\begin{array}{cc}g&g'\end{array}\right\vert
        \\[1em]
          \left\vert\begin{array}{cc}(\lambda g)'&(\lambda g)''/2\end{array}\right\vert
          \quad&=\quad \lambda^2\left\vert\begin{array}{cc}g'&g''/2\end{array}\right\vert
          - (\lambda\lambda''/2)\left\vert\begin{array}{cc}g&g'\end{array}\right\vert
        \\[0.5em]
          &\qquad+ (\lambda')^2\left\vert\begin{array}{cc}g&g'\end{array}\right\vert
          + \lambda\lambda'\left\vert\begin{array}{cc}g&g''/2\end{array}\right\vert.
        \end{aligned}
      \]
  \end{enumerate}
