...
\begin{itenv}{Scholium}
  If $\TT$ is a strongly cartesian triple, then the free $\TT$-category $\hat{\theta}=(\hat{b},\hat{a},\hat{i},\hat{k})$ generated by a $\TT$-graph $\theta=(b,a)$ on $e\in\set{\cat{E}}$ has the same object object $e$ as $\theta$.
