...
\begin{enumerate}
  \item
    ...
    \oldpage{280}
    We also denote the above envelope by $(f',(j,(j_1,\ldots,j_n)),f)$.
  ...
  \item
    ...
    The relation
    \[
      \alpha\in \Hom_\cat{A}\big( f',(j,(j_1,\ldots,j_n)),f \big)
    \]
...
\begin{enumerate}
  \item
    ...
    We say that $(j,(j_1,\ldots,j_n))\colon e\to e'$ is an \emph{envelope of $\cat{L}$} if $j\colon e\to e'$ is a morphism in $\cat{L}^\circ$ whenever $(j_1,\ldots,j_n)\colon e\to e'$ is a path in $\cat{L}^\circ$;
  ...
  \item
    ...
    The relation $\alpha\in\Hom_\cat{L}(j,(j_1,\ldots,j_n))$ is also expressed by saying that $\alpha\colon(j_1,\ldots,j_n)\to j$ is a multimorphism in $\cat{L}$.
  ...
  \item
    ...
    \[
      E\perp E'
      = (j,(j_1,\ldots,j_{i-1},j'_1,\ldots,j'_n,\ldots,j_{i+1},\ldots,j_n)).
    \]
...
\begin{rmenv}{Examples}
  \begin{enumerate}
    \item
      ...
      If $(j_1,\ldots,j_n)\colon e\to e'$ is a path in the category $\cat{C}$ and $j\colon e\to e'$ a morphism in $\cat{C}$, then $\Hom_\cat{C}(j,(j_1,\ldots,j_n))$ takes the value 1 or 0 depending on whether $j=j_1\cdot j_2\cdot\ldots\cdot j_n$ or not.
...
\begin{itemize}
  ...
  \item
    ...
    \[
      s_{u+1,v}\theta
      = (\theta\circ s_{u,v}\theta) \cdot s(\theta, \bigcirc^u\theta, \bigcirc^v\theta).
    \]
\end{itemize}
...
\label{lemma:3}
  ...
  \[
    ...
    = s_{u,v+w}\theta \cdot \big( (\bigcirc^u\theta)\circ(s_{v,w}\theta) \big) \cdot s(\bigcirc^u\theta, \bigcirc^v\theta, \bigcirc^w\theta)
  \]
...
\begin{proof}
  ...
  \[
    \begin{aligned}
      ...
      &= k \cdot (\theta\circ k_{u+v}) \cdot (\theta\circ s_{u,v}\theta) \cdot  s(\theta,\bigcirc^u\theta,\bigcirc^v\theta)
    \\&= k \cdot (\theta\circ k) \cdot \big(\theta\circ(k_u\circ k_v)\big) \cdot  s(\theta,\bigcirc^u\theta,\bigcirc^v\theta)
  ...
  \[
    ...
    \\&= k \cdot (\theta\circ k) \cdot \big(\theta\circ(k_u\circ i)\big) \cdot s(\theta,\bigcirc^u\theta,1) \cdot r(\bigcirc^{1+u}\theta)
  ...
  \[
    ...
    = \big(\theta\circ r(\bigcirc^u\theta)^{-1}\big) \cdot s(\theta,\bigcirc^u\theta,1).
  \]
...
\begin{proof}
  ...
  \[
    ...
    \\&\overset{\text{(Lemma~3)}}{=} j_{u+v+w} \cdot s_{u,v+w}\theta \cdot \big( (\bigcirc^u\theta)\circ s_{v,w}\theta \big) \cdot s(\bigcirc^u\theta, \bigcirc^v\theta, \bigcirc^w\theta)
