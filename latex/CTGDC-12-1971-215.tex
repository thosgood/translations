...
\[
  \begin{tikzcd}
  &&&T\pi
      \ar[dlll,"Ta"description]
      \ar[dl,"Tp"description]
      \ar[dddlll,"Tb"description]
  &&\pi_2
      \ar[ll,"v_2"description]
      \ar[dl,"p'"description]
      \ar[ddll,"v_1"description]
  \\TTe
  && T\pi'
      \ar[ur,bend left=50,"Ts"description]
      \ar[ll,"Ta'"description]
      \ar[ddll,"Tb'"description]
  &&\pi'_2
      \ar[ur,bend left=50,"s'"description]
      \ar[ll,"v'_2"description]
      \ar[ddll,"v'_1"description]
  \\[2em]
  &&&\pi
      \ar[dlll,"a"description]
      \ar[dl,"p"description]
      \ar[dddlll,"b"description]
  \\[-1em]Te
  && \pi'
      \ar[ur,bend left=50,"s"description]
      \ar[ll,"a'"description]
      \ar[ddll,"b'"description]
  \\{}
  \\[2em]e
  \end{tikzcd}
\]
