...
We further say that $\Delta$ is \emph{countable} if $\Delta_0$ is finite or countable (see \cref{sec:a.3} for an interpretation of theories in terms of multicategories).
...
\begin{proof}
  ...
  We have that $d\theta\cdot IF\theta = FI\theta$ by taking $\varepsilon=1$ in~(6), hence the first of the relations~(2).
  For all
  \[
