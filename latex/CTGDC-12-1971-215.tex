...
The ``global'' definition of a category of operators coincides with that of a \emph{coétale functor} (called a functor of hypermorphisms in the terminology of \cite{Eh} --- see, for example, the ``sketch'' of this structure in \cite{Bu}).
We say that a functor $\overline{\phi}\colon\overline{\cat{C}}\to\cat{C}$ is coétale if, for every $\overline{e}\in\set{\overline{\cat{C}}}$ and every morphism in $\cat{C}$ of the form $f\colon\overline{\phi}(\overline{e})\to e'$, there exists a unique morphism in $\cat{C}$ of the form $\overline{f}\colon\overline{e}\to\overline{e}'$ such that $\overline{\phi}(\overline{f})=f$.
More generally, suppose that $\cat{E}$ is a category that admits finite fibre products;
then we say that an $\cat{E}$-functor $(f_0,f)\colon(\overline{b},\overline{a},\overline{i},\overline{k})\to(b,a,i,k)$ is \emph{coétale} if $(f,\overline{a})$ is a fibre product of $(a,f_0)$ (compare with the generalisations of this notion in \cref{sec:IV}).
We denote by $\Op{\cat{E}}$ the full subcategory of $\Cat{Cat}(\cat{E})^\mathbf{2}$ whose objects are the coétale $\cat{E}$-functors.
...
\begin{itemize}
  ...
  \item
    ...
    The morphisms of $\hat{\cat{S}}_5$ and $\hat{\cat{S}}_6$ are called \emph{$\cat{R}$-étale} and \emph{$\cat{R}$-coétale} (respectively).
...
\begin{rmenv}{Examples}
  ...
  If $\cat{R}$ is the subcategory of invertible morphisms in $\cat{E}$, then a $\TT$-functor for $\hat{\cat{S}}=\hat{\cat{S}}_5$ or $\hat{\cat{S}}_6$ is called an \emph{étale} or \emph{coétale} functor (respectively).
\end{rmenv}
