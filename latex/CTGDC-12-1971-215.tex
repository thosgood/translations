...
We can recognise the construction of the underlying $\NN$-graph of the free $\NN$-category generated by the $\NN$-graph $\cat{A}$, by following the method of the scholium of \unsure{Proposition~III.2.21}.
...
\begin{proof}
  ...
  By hypothesis, the sums in $\cat{E}$ are cartesian (see the \unsure{lemma of Proposition~III.1.20}), which implies that the data of $a'$ is evidently equivalent to that of the pair $(a,c)$.
