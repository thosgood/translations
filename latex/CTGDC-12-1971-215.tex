...
\begin{proof}
  ...
  we will define an adjoint functor $F\colon\Gr{\TT}\to\Cat{Cat}(\TT)$ by using \unsure{Proposition~A.1} in the appendix.
...
\begin{proof}
  If $\TT'=(T',I',K')$ is the induced triple on $\Gr{\TT}$, then the proof of \unsure{Proposition~A.1} in the appendix shows that, for all $\theta\in\set{\Gr{\TT}}$, $T'\theta$ is a countable sum, $I'\theta$ is a canonical injection of this sum, and $K'\theta$ is a crochet of the sum $T'T'\theta$;
