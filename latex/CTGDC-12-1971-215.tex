...
\begin{proof}
  ...
  \[
    ...
    \end{aligned}
  \]
  combined with the fibre product $(m_2,m'_2)$ of $(Ta_4,Ke_4\cdot Tb_3\cdot u_2)$ give a \unsure{bracket} $d_2$ characterised by
  \[
    \begin{aligned}
      m_2\cdot d_2
  ...
  \[
    ...
    \end{aligned}
  \]
  combined with the fibre product $(t,t')$ give a \unsure{bracket} $p$ characterised by
  \[
    \begin{aligned}
      t\cdot p
      &= Td_2\cdot w_1
  ...
  \[
    ...
    \end{aligned}
  \]
  combined with the fibre product $(n,n')$ of $(Ta_4,Ke_4\cdot T(Ke_4\cdot Tb_3\cdot u_2)\cdot v_1)$ give a \unsure{bracket} $p$ characterised by
  \[
    \begin{aligned}
      n\cdot p'
  ...
  \]
  gives a \unsure{bracket} $d_1$ characterised by
  \[
    \begin{aligned}
      m_1\cdot d_1
  ...
  \[
    ...
    \end{aligned}
  \]
  combined with the fibre product $(o,o')$ of $(Ta_4,Ke_4\cdot Tb_3\cdot m_1)$ give a \unsure{bracket} characterised by
  \[
    \begin{aligned}
      o\cdot p''
      &= n
  ...
  \[
    ...
    \end{aligned}
  \]
  combined with the fibre product $(o,o')$ give a \unsure{bracket} $x$ such that
  \[
    \begin{aligned}
      o\cdot x
    ...
    \tag{8}
  \]
  It is the uniqueness property of this \unsure{bracket} that will allow us to complete the proot;
