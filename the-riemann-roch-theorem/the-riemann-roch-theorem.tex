...
\begin{proof}
  ...
  The exact sequence of $\Tor$, applied to \cref{equation1}, gives the exact sequence
  \[
...
\oldpage{123}
  ...
  But $\mathfrak{M}$, thought of as a tensor product of the algebras $\sh{O}_Y$ and $\bigwedge V$, is clearly a differential graded algebra, \todo
\end{proof}
