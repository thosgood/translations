...
\label{proposition15}
  \hyperref[theoremriemannroc]{R-R} is true for an injection.
\end{proposition}
...
\begin{proof}
  ...
  In this case, $g^!(y)\cdot\lambda_{-1}F^*\equiv0\mod(1-L^*)$, by part~(d) of \cref{lemma19}, and so is in the image of $K(X')$ under $j^!$ (\cref{proposition13}), and (\cref{proposition14}) we can apply \hyperref[theoremriemannroc]{R-R} to $g^!(y)\cdot\lambda_{-1}F^*$ and $j$.
  This gives
  \[
